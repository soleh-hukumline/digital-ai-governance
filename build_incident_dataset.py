...
TYPE_DEFAULTS = {
    ...
    "defacement": {
        "kualifikasi": "Akses ilegal dan perubahan/perusakan tampilan sistem elektronik (Pasal 30 & Pasal 32 jo. Pasal 46 & Pasal 48 UU ITE).",
...
_ROLE_TEMPLATES = {
    "data": [  # data_breach, ransomware, defacement
        ("pelaku", "Perpetrator",
         ...
         ["UU ITE Ps. 30, 32 jo. Ps. 46, 48", "UU ITE Ps. 27B (pemerasan)", "UU PDP Ps. 67–68", "KUHP"]),
        ("pse", "Operator (PSE)",
    ...
    "ai": [  # ai_deepfake, ai_ncii, ai_disinformation
        ...
        ("pse", "Platform / PSE",
         ...
         ["PP PSTE No.71/2019", "UU PDP (data biometrik)", "SE Menkominfo No. 9/2023 Etika Kecerdasan Artifisial (pedoman, tidak mengikat)"]),
        ("korban", "Victim",
         ...
         ["UU PDP Ps. 8 (hak penghapusan)", "UU 12/2022 TPKS", "UU ITE Ps. 26"]),
        ("regulator", "Regulator / state",
         ...
         ["Komdigi", "Kepolisian", "SE Menkominfo No. 9/2023 Etika AI (kini Komdigi; pedoman tidak mengikat)"]),
    ],
    "other": [  # conduct / exposure cases (qualification is per-incident)
        ...
        ("konsumen", "Affected party / consumer",
         ...
         ["UU 8/1999 Perlindungan Konsumen / UU 4/2023 P2SK Ps. 235 dst. (pelindungan konsumen sektor keuangan)", "UU PDP Ps. 5–12"]),
        ("regulator", "Regulator / state",
...
RECORDS = [
    ...
    },
    {
        ...
        "kualifikasi": "Dugaan kelalaian pengamanan akses data pribadi pada Sistem Elektronik publik (saat insiden 2021 tunduk pada Pasal 24 PP No. 71/2019 tentang PSTE; kewajiban serupa kini diatur Pasal 35 & Pasal 36 UU No. 27/2022 tentang PDP, yang tidak berlaku surut).",
    ...
    },
    {
        ...
        "kualifikasi": "Pelanggaran perlindungan konsumen sektor jasa keuangan dan praktik penagihan melawan hukum (UU 4/2023 P2SK & POJK 6/POJK.07/2022 tentang Perlindungan Konsumen dan Masyarakat di Sektor Jasa Keuangan — kini POJK 22/2023); sanksi administratif OJK.",
